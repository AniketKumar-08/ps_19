                  ...
                  <View style={{
                    ...
                    <View style={{paddingBottom: 20}}>
                        ...
                        fontWeight: 'semibold',
                         ...
                         A debugging contest where contestants put their problem solving, algorithmic thinking and analytical skills to
test. In the competition, algorithm based programs (in C, C++, and Java) will be given with syntactical,
logical or program design errors.
                        </Text>
