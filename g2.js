            ...
            <View style={{paddingLeft:13,
                  ...
                  <View style={{
                    ...
                    <View style={{paddingBottom: 20}}>
                        ...
                        Eco-Friendly vehicles have invaluable benefits to the environment. So keeping this concept in mind a
fun filled path is designed.
Obstacles will be allocated throughout the path, participants will be given a scenario based on which
they have to ride in the respective path using an Eco-friendly vehicle.
