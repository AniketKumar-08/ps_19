            ...
            <View style={{paddingLeft:13,
                  ...
                  <View style={{
                    ...
                    <View style={{paddingBottom: 20}}>
                        ...
                        Fed up of being Gridlocked in Bangalore traffic? Well, can’t help you with that, but we can definitely
help you get out of this mathematical Gridlock. PENTAGRAM, the Mathematical Society of
BMSCE, brings you a fun cocktail of puzzles and riddles that will test your skills and a little more
                        </Text>
                        ...
                        <Text style={{fontSize: 15,
                         ...
                         Date: 14/09/2019
                          ...
                          <Text style={{fontSize: 15,
                           ...
                           Venue:CR 306 and CR 307 & M.tech Classroom, New Building.
                        </Text>
                        </View>
                    </View>
                    <View style={{padding:7,
